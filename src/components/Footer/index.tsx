    ...
    <StyledFooter>
      ...
      <Container>
        <HeaderRow>
          ...
          <Description>
            {' '}
            MetaComs is a platform with the goal to achieve a sustainable world with prosperity for all.{' '}
          </Description>
        </HeaderRow>
        <LinkContainer>
        ...
        <LinkContainer>
          ...
          <Item href="https://polygonscan.com/token/0x111763fb1D088Bf4f058ee8e38ec35cc0E805Ecc">2LC Contract</Item>
        ...
        <LinkContainer>
          ...
          <Item href="https://github.com/2local/Staking-Pool-Public">MEAC SWAP</Item>
        </LinkContainer>
      </Container>
      <Divider />
    </StyledFooter>
